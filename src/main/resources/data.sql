...
-- 123 게시글
insert into article (id, title, content, createdAt , modifiedAt, createdBy, modifiedBy) values
...
--
-- -- 300 댓글
-- insert into article_comment (article, id, parent_comment_id, content, created_at, modified_at, created_by, modified_by) values
